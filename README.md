...
- 조별주제는 https://docs.google.com/spreadsheets/d/1cysxO9JDLIQH0y6yMfmX8KUYX-H2HyHp9BjaRMaBl-U/edit#gid=0 여기에 작성한 거에 기반한다. 변동사항이 있는 조는 따로 메일로 회신.
...
- 발표 자료는 23일 18시 이전 mongmaker721@gmail.com 으로 제출한다.(조 이름, git 주소, 실행 가능 url, 조원별 github id 포함)
- 조별로 주제, giturl, 실행 가능한 url을 github issue로 등록한다.
- 발표는 
  - 발표 주제
  - 과제 하면서 제일 중심을 뒀던 부분
  - 실제 제품 실행
